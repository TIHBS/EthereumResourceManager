...
contract BasicHotelManager {
    ...
    function getReceipt() pure external returns (string memory) {
        return "0x37571325BF7A44d8e7DB2B76c673A03501023465";
    }

    function hasReservation() public view returns (bool) {
